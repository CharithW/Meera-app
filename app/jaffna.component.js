System.register(['angular2/core', './meeting.service', 'angular2/http', './Validations'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            JaffnaComponent = (function () {
                function JaffnaComponent(_meetingService) {
                    ...
                    this.status = '';
                    this.remainingTime = '';
                    this.image = "images/JT41014.jpg";
                }
                JaffnaComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._meetingService.getMeetings()
                        .subscribe(function (meetings) {
                        meetings.forEach(function (element) {
                            if (((element.location).indexOf("Jaffna")) !== -1) {
                ...
                return JaffnaComponent;
            }());
            exports_1("JaffnaComponent", JaffnaComponent);
        }
    }
});
//# sourceMappingURL=jaffna.component.js.map