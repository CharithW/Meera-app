System.register(['angular2/core', './meeting.service', 'angular2/http', './Validations'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            GalleComponent = (function () {
                function GalleComponent(_meetingService) {
                    ...
                    this.status = '';
                    this.remainingTime = '';
                    this.image = "images/galle-dutch-fort-sri-lanka-mysrilankatravel.jpg";
                }
                GalleComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                return GalleComponent;
            }());
            exports_1("GalleComponent", GalleComponent);
        }
    }
});
//# sourceMappingURL=galle.component.js.map